 ...
 *
 */
public class TrackerTCPSampler extends AbstractSampler implements ThreadListener, Interruptible {
    private static final long serialVersionUID = 1280L;

    private static final Logger log = LoggerFactory.getLogger(TrackerTCPSampler.class);

    private static final Set<String> APPLIABLE_CONFIG_CLASSES = new HashSet<>(
            Arrays.asList(
                    "org.apache.jmeter.config.gui.LoginConfigGui",
                    "org.apache.jmeter.protocol.tcp.config.gui.TrackerTCPConfigGui",
                    "org.apache.jmeter.config.gui.SimpleConfigGui"
            ));

    public static final String SERVER = "TrackerTCPSampler.server"; //$NON-NLS-1$

    public static final String PORT = "TrackerTCPSampler.port"; //$NON-NLS-1$

    public static final String FILENAME = "TrackerTCPSampler.filename"; //$NON-NLS-1$

    public static final String CLASSNAME = "TrackerTCPSampler.classname";//$NON-NLS-1$

    public static final String NODELAY = "TrackerTCPSampler.nodelay"; //$NON-NLS-1$

    public static final String TIMEOUT = "TrackerTCPSampler.timeout"; //$NON-NLS-1$

    public static final String TIMEOUT_CONNECT = "TrackerTCPSampler.ctimeout"; //$NON-NLS-1$

    public static final String REQUEST = "TrackerTCPSampler.request"; //$NON-NLS-1$

    public static final String RE_USE_CONNECTION = "TrackerTCPSampler.reUseConnection"; //$NON-NLS-1$
    public static final boolean RE_USE_CONNECTION_DEFAULT = true;

    public static final String CLOSE_CONNECTION = "TrackerTCPSampler.closeConnection"; //$NON-NLS-1$
    public static final boolean CLOSE_CONNECTION_DEFAULT = false;

    public static final String SO_LINGER = "TrackerTCPSampler.soLinger"; //$NON-NLS-1$

    public static final String EOL_BYTE = "TrackerTCPSampler.EolByte"; //$NON-NLS-1$
    ...
    public static final String SIGNAL = "TrackerTCPSampler.signal";
    ...
    public void setSignalData(String newSignalDate) {
        this.setProperty(SIGNAL, newSignalDate);
    }

    public String getSignalData() {
        return getPropertyAsString(SIGNAL);
    }
    ...
    public SampleResult sample(Entry e)// Entry tends to be ignored ...
    {
        ...
        try {
            ...
            if (sock == null) {
                ...
                protocolHandler.write(os, signal, req);
